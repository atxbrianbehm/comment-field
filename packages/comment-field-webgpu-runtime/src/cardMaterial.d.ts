...
export interface CardMaterial extends THREE.Material {
  cardUniforms: {
    ...
    motionCenterX: MutableUniformNode;
    motionCenterY: MutableUniformNode;
    motionUAxisX: MutableUniformNode;
    motionUAxisY: MutableUniformNode;
    motionVAxisX: MutableUniformNode;
    motionVAxisY: MutableUniformNode;
    motionAmount: MutableUniformNode;
    lightDirectionX: MutableUniformNode;
    lightDirectionY: MutableUniformNode;
